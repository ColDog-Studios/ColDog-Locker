...
2. Open a [private security advisory](https://github.com/ColDog-Studios/ColDog-Locker/security/advisories/new) on GitHub
3. Alternatively, email security reports to: contact@coldogstudios.com
